...
class Therapist(BaseModel):
    id_therapist: Optional[str] = Field(max_length=20, min_length=1)
    register_date: str = Field(default=datetime.now().strftime("%Y/%m/%d %H:%M"))
    names: str = Field(default="Sin nombre", max_length=100, min_length=10)
    ...
    email: str = Field(default="Sin especificar", max_length=100, min_length=10)
